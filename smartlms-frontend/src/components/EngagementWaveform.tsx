...
export default function EngagementWaveform({ 
  ...
  return (
    <div className="w-full h-full bg-surface/30 rounded-[2.5rem] border border-white/5 p-6 flex flex-col relative overflow-hidden group transition-all hover:bg-surface/40">
